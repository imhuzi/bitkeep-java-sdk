...
public class JsonUtil {
    ...
    public static <T> T toObject(String rsp, TypeReference type) {
        try {
            return getObjectMaper().readValue(rsp, type);
        } catch (IOException e) {
    ...
    public static <R> List<R> toObject(String rsp, Type type) {
        try {
            return getObjectMaper().readValue(rsp, new TypeReference<Type>(){});
        } catch (IOException e) {
            log.error("JsonUtil->toObject: error", e);
            return null;
        }
    ...
    public static <T> T toObject(String jsonString, Class<T> clazz) {
        try {
            return getObjectMaper().readValue(jsonString, clazz);
        } catch (IOException e) {
            log.error("JsonUtil->toObject: error", e);
            return null;
        }
...
//        ArrayList d = JsonUtil.toObject(str, ArrayList.class);
